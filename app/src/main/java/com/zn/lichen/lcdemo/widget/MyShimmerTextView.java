...
public class MyShimmerTextView extends TextView {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        mViewWidth = getMeasuredWidth();        //可以尝试一下，使用不同的模式可以得到不同的效果
        mLinearGradient = new LinearGradient(0, 0, mViewWidth, 0, new int[]{Color.RED, Color.GREEN, Color.BLUE}, null, Shader.TileMode.MIRROR);
